"""Support for Sony projectors Test via SDCP network control."""
...
DEFAULT_NAME = "Sony Projector Test"
...
def setup_platform(
    ...
    """Connect to Sony projector Test using network."""
    ...
    add_entities([SonyProjectorTest(sdcp_connection, name)], True)


class SonyProjectorTest(SwitchEntity):
